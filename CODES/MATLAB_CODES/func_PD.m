function der_state=func_PD(~,state,Kp1,Kd1,Kp2,Kd2,q1_des,q2_des,m1,m2,l1,l2,g)
...
e1=q1_des-q1;
e2=q2_des-q2;
tau1=Kp1*e1+Kd1*(-q1_dot);
tau2=Kp2*e2+Kd2*(-q2_dot);
Tau=[tau1;tau2];

q_dot_dot=M\(Tau-C*[q1_dot;q2_dot]-G);

der_state=[q1_dot;q2_dot;q_dot_dot(1);q_dot_dot(2)];
end